...
@protocol PanoramaDelegate
-(void) screenLocationsDidUpdate:(NSArray*)screenLocations;
@end
...
@interface TextureRect : NSObject
-(bool) execute;
...
@property id <PanoramaDelegate> panoDelegate;

@property (nonatomic) NSMutableArray *screenLocations;
@property (nonatomic) NSArray *stationLocations;
